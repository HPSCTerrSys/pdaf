...
SUBROUTINE obs_op_f_pdaf(step, dim_p, dim_obs_f, state_p, m_state_f)
     ...
     USE mod_assimilation, &
          ...
          var_id_obs, dim_obs_p, tws_temp_mean_d 
     ...
     if (clmupdate_tws.ne.1) then
        ...
        CALL mpi_allgatherv(m_id_p_tmp, local_dims_obs(mype_filter+1), &
             MPI_INT, obs_nc2pdaf_deprecated, local_dims_obs, local_dis, &  
        ...
        ! Clean up
        DEALLOCATE(m_state_tmp, local_dis,m_id_p_tmp,obs_nc2pdaf_deprecated_tmp)
